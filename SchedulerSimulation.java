...
class Process implements Runnable {
    ...
    private int priority; // Priority (1 to 5)
    
    // #3: Fields to track waiting time
    ...
    // # 1: Added priority parameter to constructor
    // #3: Initialize timing fields
    ...
    // #3: Get for creation time
    public long getCreationTime() {
        return creationTime;
    }
    
    // #3: Get for total waiting time
    public long getTotalWaitingTime() {
        return totalWaitingTime;
    }
    
    // #3: Get for last ready time
    public long getLastReadyTime() {
        return lastReadyTime;
    }
    
    // #3: Method to update waiting time when process is about to run
    ...
    // #3: Method to set last ready time when process re-enters queue
...
public class SchedulerSimulation {
    ...
    // #2: Static counter for context switches
    private static int contextSwitchCount = 0;
    
    // #3: List to store all completed processes for summary
    private static List<Process> completedProcesses = new ArrayList<>();

    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 443830523;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            // #1: random priority between 1 to 5
        ...
        while (!processQueue.isEmpty()) {
            ...
            // #2: get bigeer switch counter when a new process starts running
            contextSwitchCount++;
            ...
            if (!process.isFinished()) {
                ...
                if (!processQueue.isEmpty()) {
                    // #3: Set last ready time when re-entering queue
                    ...
                    // #3: to completed processes list for summary
        ...
        //#2: Display total context end of simulation
        ...
        // #3: Display waiting time summary table at the end
        displayWaitingTimeSummary();
    }
    
    // Method to add a process to the queue and map, while printing a "ready" message
    // #1: Update to priority 
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue, 
        ...
        // #1: Updated output to have priority
    ...
    //  #3: Method to display waiting time summary table
